...
public class PokemonEau extends Pokemon {
	...
	public void attaquer(PokemonEau p) {
		...
		System.out.println("\t\t\t                    |\t\t        |\t\t        ");
                if(!isDead()){
                    System.out.println("\t\t\t          " + String.format("%-10s", this.nom) + "|\t\t" + String.format("%4.2f", this.hp) + "  |\t\t" +this.atk + "\t EAU");
                } else {
                    System.out.println("\t\t\t          " + String.format("%-10s", this.nom) + "|\t\t" + String.format("%3.2f", this.hp) + "  |\t\t" +this.atk + "\t EAU" + "\t\t\tMORT");
                }
		System.out.println("\t\t\t                    |\t\t        |\t\t        ");
	}
        ...
        public String toString(){
            return this.nom.toUpperCase() + " ( HP = " + this.hp + ", ATTAQUE = " + this.atk + " TYPE = EAU )" ;
        }
}
